...
# def imgcut_basedoncoin_yolov3_jdcb(img):
#     colorgap_list = [50, 20, 70, 130, 90, 35, 80, 65, 15, 75, 100, 55, 120, 30, 25, 105, 110, 185, 95]
#     # colorgap_list = [130, 140, 150, 160, 170, 180, 190, 200, 210, 220, 230, 240, 250]
#     #colorgap_list = [120]
#     #colorgap_list = [100]
...
def imgcut_basedoncoin_test(img_dir, destination_dir, failed_dir):
    ...
    for image_filename in file_dir:
        ...
        imgcuted, size = imgcut_basedoncoin_yolov3(image)
...
if __name__ == "__main__":
    ...
    img_dir = "jpgimages"
    destination_dir = "result/200/s"
    failed_dir = "result/200/f"
    imgcut_basedoncoin_test(img_dir, destination_dir, failed_dir)


# img = cv2.imread("image/0243b8.jpg")
# img,size = imgcut_basedoncoin_yolov3(img)
# cv2.imwrite("11.jpg", img)
# img1 = cv2.imread("image/0243b8.jpg")
# img1,size1 = imgcut_basedoncoin_yolov3_jdcb(img1)
